                ...
                <div class="col-xl-6 col-5">
                    <div class="site">
                        ...
                        <div class="site__brand">
                            <a title="Logo" href="{{url('/')}}" class="site__brand__logo"><img src="{{asset('home/logo.png')}}" alt="Golo"></a>
                        </div><!-- .site__brand -->
    ...
    <main id="main" class="site-main">
            ...
            <div class="container">
                <div class="site-banner__content">
                    <h1 class="site-banner__title">
                        يقدم Taskellow</h1>
                    <div class="title-wrap"> مجموعة متكاملة من الأدوات والميزات المصممة <strong>لتلبية احتياجات</strong> شركات التسويق </div>

                </div><!-- .site-banner__content -->
            </div>
        </section><!-- .site-banner -->
        <section class="features layout-02">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="item hover__box">
                                <a href="#">
                                    <img src="images/workspace/cat-01.jpg" alt="">
                                    <span class="info">
                                            <span>Coworking Space</span>
                                            <img src="images/workspace/cat-line-01.png" alt="">
                                        </span>
                                </a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="item hover__box">
                                <a href="#">
                                    <img src="images/workspace/cat-02.jpg" alt="">
                                    <span class="info">
                                            <span>Meeting Room</span>
                                            <img src="images/workspace/cat-line-02.png" alt="">
                                        </span>
                                </a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="item hover__box">
                                <a href="#">
                                    <img src="images/workspace/cat-03.jpg" alt="">
                                    <span class="info">
                                            <span>Virtual Office</span>
                                            <img src="images/workspace/cat-line-03.png" alt="">
                                        </span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-01.jpeg" alt=""></a></div>
                                <div class="entry-detail">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-02.jpeg" alt=""></a></div>
                                <div class="entry-detail">
                                    <h3><a href="#">Boston</a></h3>
                                    <span>72 Spaces</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-03.jpeg" alt=""></a></div>
                                <div class="entry-detail">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-04.jpeg" alt=""></a></div>
                                <div class="entry-detail">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-05.jpeg" alt=""></a></div>
                                <div class="entry-detail">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="item hover-img">
                            <div class="item-inner">
                                <div class="entry-thumb"><a href="#"><img src="images/workspace/city-06.jpeg" alt=""></a></div>
                                <div class="entry-detail">
        ...
        <section class="testimonial-wrap">
            <div class="container">
                ...
                <div class="slick-sliders offset-item">
                    <div class="slick-slider testimonial-slider layout-03 slider-pd30" data-item="3" data-arrows="true" data-itemScroll="3" data-dots="true" data-centerPadding="30" data-tabletitem="1" data-tabletscroll="1" data-mobileitem="1" data-mobilescroll="1" data-mobilearrows="false">
                        <div class="testimonial-item">
                            <div class="testimonial-info">
                                ...
                                <div class="testimonial-meta">
                                    <div class="avatar">
                                        <img src="images/avatars/male-1.jpg" alt="Avatar" class="ava">
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-info">
                                ...
                                <div class="testimonial-meta">
                                    <div class="avatar">
                                        <img src="images/avatars/female-1.jpg" alt="Avatar" class="ava">
                                    </div>
                                    <div class="author">
                                        <b>Kari Granleese</b>
                                        <span>CEO Alididi</span>
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-info">
                                ...
                                <div class="testimonial-meta">
                                    <div class="avatar">
                                        <img src="images/avatars/female-3.jpg" alt="Avatar" class="ava">
                                    </div>
                                    <div class="author">
                                        <b>Kari Granleese</b>
                                        <span>CEO Alididi</span>
        ...
        <section class="banner-wrap">
            <div class="container">
                <div class="banner-inner" style="background-image: url(images/workspace/desk-home.png);">
                    <h2>List your space for free</h2>
                    <p>It's easy to list, simple to manage and, best of all, free to list!</p>
                    <a href="#" class="btn">Add your space</a>
                </div>
            </div>
        </section><!-- .banner-wrap -->
        <section class="blogs-wrap layout-02">
            <div class="container">
                <div class="title-wrap align-center">
                    <h2>From Our Blog</h2>
                </div>
                <div class="blog-wrap offset-item">
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <article class="post hover__box">
                                <div class="post__thumb hover-img">
                                    <a title="The 8 Most Affordable Michelin Restaurants in Paris" href="blog-detail.html"><img src="images/workspace/blog-01.jpg" alt="The 8 Most Affordable Michelin Restaurants in Paris"></a>
                                </div>
                        ...
                        <div class="col-12 col-lg-4">
                            <article class="post hover__box">
                                <div class="post__thumb hover-img">
                                    <a title="The 8 Most Affordable Michelin Restaurants in Paris" href="blog-detail.html"><img src="images/workspace/blog-03.jpg" alt="The 8 Most Affordable Michelin Restaurants in Paris"></a>
                                </div>
                                <div class="post__info">
                                    <ul class="post__category">
                                        <li><a title="Paris" href="02_city-details_1.html">Paris</a></li>
    ...
    <footer id="footer" class="footer">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="footer__top__info">
                            <a title="Logo" href="{{url('/')}}" class="footer__top__info__logo"><img src="{{asset('home/logo.png')}}" alt="Golo"></a>
                            <p class="footer__top__info__desc">Taskellow هو نظام إدارة مهام مبتكر مصمم خصيصًا لشركات التسويق لتحسين كفاءة العمليات اليومية وضمان تقديم خدمة عملاء متميزة. نسعى لتسهيل إدارة المهام وتبسيط العمل الجماعي من خلال توفير أدوات تساعد في تتبع أداء الموظفين، تنظيم العمل، وتخصيص المهام بشكل ذكي وسريع.
                            </p>
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{\Carbon\Carbon::now()->year}} &copy; <a title="Intshar" href="#">intshar.com</a>. كل الحقوق محفوظة.</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
</div><!-- #wrapper -->
